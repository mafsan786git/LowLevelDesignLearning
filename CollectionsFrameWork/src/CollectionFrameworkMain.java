...
public class CollectionFrameworkMain {
    public static void main(String[] args) {
       //https://notebook.zohopublic.in/public/notes/u3i1sf9bea7a6f25c4a60941d06a07ac8d76c

        System.out.println("Hello world!");
//        CollectionObjects collectionObjects  =  new CollectionObjects();
//        collectionObjects.useCollectionObjects();

//        // testing CollectionsUtil class
//        CollectionsUtility collectionsUtility = new CollectionsUtility();
//        collectionsUtility.usingCollectionsUtility();;
